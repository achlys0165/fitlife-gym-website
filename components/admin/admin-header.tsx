...
const navItems = [
  ...
  { href: "/admin/classes", icon: CalendarDays, label: "Classes" },
    ...
    <>
      <header className="sticky top-0 z-30 flex items-center justify-between h-16 px-4 lg:px-6 border-b bg-card">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden lg:flex items-center gap-2 rounded-lg bg-muted px-3 py-2">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <nav className="absolute left-0 top-0 bottom-0 w-72 bg-sidebar text-sidebar-foreground flex flex-col" aria-label="Mobile admin navigation">
